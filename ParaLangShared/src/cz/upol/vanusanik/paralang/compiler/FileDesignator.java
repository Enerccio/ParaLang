...
/**
 * FileDesignator is abstract interface for multiple types of source files
 * (net/disk/archive etc)
 * 
 * @author Enerccio
 *
 */
public interface FileDesignator {
	...
	/**
	 * Returns File of the file. Only applicable if is real file. Otherwise
	 * returns null.
	 * 
	 * @return
	 */
