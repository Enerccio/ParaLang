...
public abstract class BaseNumber extends PLClass implements Serializable {
	...
	protected void ___init_internal_datafields(BaseCompiledStub self) {
		...
		___setkey(Operator.EQ.classMethod, new FunctionWrapper("__eq_base",
				this, true));
		___setkey(Operator.NEQ.classMethod, new FunctionWrapper("__neq_base",
				this, true));
		___setkey(Operator.BITAND.classMethod, new FunctionWrapper(
				"__bitand_base", this, true));
		___setkey(Operator.BITOR.classMethod, new FunctionWrapper(
				"__bitor_base", this, true));
		___setkey(Operator.BITXOR.classMethod, new FunctionWrapper(
				"__bitxor_base", this, true));
		___setkey(Operator.DIV.classMethod, new FunctionWrapper("__div_base",
				this, true));
		___setkey(Operator.LEQ.classMethod, new FunctionWrapper("__leq_base",
				this, true));
		___setkey(Operator.LESS.classMethod, new FunctionWrapper("__less_base",
				this, true));
		___setkey(Operator.LSHIFT.classMethod, new FunctionWrapper(
				"__lshift_base", this, true));
		___setkey(Operator.MEQ.classMethod, new FunctionWrapper("__meq_base",
				this, true));
		___setkey(Operator.MINUS.classMethod, new FunctionWrapper(
				"__minus_base", this, true));
		___setkey(Operator.MOD.classMethod, new FunctionWrapper("__mod_base",
				this, true));
		___setkey(Operator.MORE.classMethod, new FunctionWrapper("__more_base",
				this, true));
		___setkey(Operator.MUL.classMethod, new FunctionWrapper("__mul_base",
				this, true));
		___setkey(Operator.PLUS.classMethod, new FunctionWrapper("__plus_base",
				this, true));
		___setkey(Operator.RSHIFT.classMethod, new FunctionWrapper(
				"__rshift_base", this, true));
		___setkey(Operator.RUSHIFT.classMethod, new FunctionWrapper(
				"__rushift_base", this, true));

		___setkey(Operator.LPLUSPLUS.classMethod, new FunctionWrapper(
				"__lpp_base", this, true));
		___setkey(Operator.LMINUSMINUS.classMethod, new FunctionWrapper(
				"__lmm_base", this, true));

		___setkey(Operator.UPLUS.classMethod, new FunctionWrapper("__up_base",
				this, true));
		___setkey(Operator.UMINUS.classMethod, new FunctionWrapper("__um_base",
				this, true));
