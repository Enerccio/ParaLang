...
public class BidiMultiHashMap<K, V> extends AbstractBidiMultiMap<K, V>
	...
	protected class EntrySet extends AbstractSet<Entry<K, V>> {
		...
		public boolean contains(Object entry) {
			if (entry instanceof Map.Entry) {
				...
				return getEntry(e.getKey() != null ? e.getKey() : NULL,
						e.getValue() != null ? e.getValue() : NULL) != null;
			}
			return false;
		}
		...
		public boolean remove(Object obj) {
			...
			while (entry != null) {
				if (entry.entryHashCode == hashCode
